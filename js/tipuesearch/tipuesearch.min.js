...
d_w=d_t.split(' ');for(var i=0;i<tipueslide.pages.length;i++)
{var score=0;var s_t=tipueslide.pages[i].text;for(var f=0;f<d_w.length;f++)
{if(set.wholeWords)
{var pat=new RegExp('\\b'+d_w[f]+'\\b','gi');}
else
{var pat=new RegExp(d_w[f],'gi');}
if(tipueslide.pages[i].title.search(pat)!=-1)
{var m_c=tipueslide.pages[i].title.match(pat).length;score+=(20*m_c);}
if(tipueslide.pages[i].text.search(pat)!=-1)
{var m_c=tipueslide.pages[i].text.match(pat).length;score+=(20*m_c);}
if(tipueslide.pages[i].tags)
{if(tipueslide.pages[i].tags.search(pat)!=-1)
{var m_c=tipueslide.pages[i].tags.match(pat).length;score+=(10*m_c);}}
if(tipueslide.pages[i].url.search(pat)!=-1)
{score+=20;}
if(score!=0)
{for(var e=0;e<tipuesearch_weight.weight.length;e++)
{if(tipueslide.pages[i].url==tipuesearch_weight.weight[e].url)
{score+=tipuesearch_weight.weight[e].score;}}}
if(d_w[f].match('^-'))
{pat=new RegExp(d_w[f].substring(1),'i');if(tipueslide.pages[i].title.search(pat)!=-1||tipueslide.pages[i].text.search(pat)!=-1||tipueslide.pages[i].tags.search(pat)!=-1)
{score=0;}}}
if(score!=0)
{found.push({"score":score,"title":tipueslide.pages[i].title,"desc":s_t,"img":tipueslide.pages[i].img,"url":tipueslide.pages[i].url,"note":tipueslide.pages[i].note});c++;}}}
else
{for(var i=0;i<tipueslide.pages.length;i++)
{var score=0;var s_t=tipueslide.pages[i].text;var pat=new RegExp(d,'gi');if(tipueslide.pages[i].title.search(pat)!=-1)
{var m_c=tipueslide.pages[i].title.match(pat).length;score+=(20*m_c);}
if(tipueslide.pages[i].text.search(pat)!=-1)
{var m_c=tipueslide.pages[i].text.match(pat).length;score+=(20*m_c);}
if(tipueslide.pages[i].tags)
